...
echo "\e[95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[96m_________________   BY Rizky  _________________ \n";
echo "\e[96m          INI SCRIPT GOJEK INI GRATIS BRO                \n";
echo "\e[96m           JADI GUNAKANLAH DENGAN BIJAK                 \n";
echo "\e[96m             * REPACK BY  : @mrizky232 *            \n";
...
else
{
		...
		echo "\e[96m[🚫]           \e[91mMASIH AJA NGEYEL LU      \e[96m [🚫]\n";
	        echo "\e[96m[🚫] \e[91mBELOM PERNAH DICIPOK BENCONG YA LO WKWKWKW \e[96m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
...
// function change(){
        ...
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬* SANTUY DULU KAWAN *▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","# CLAIM VOUCHER DULU KAWAN RIZKY ");
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("nevy","# CLAIM FOOD 30K + 35K + 35K");
        ...
        echo "\n".color("yellow","# SABAR YA , DIKIT LAGI KOK BIAR BISA");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(5);
        }
        ...
        $TOKEN  = "1373612051:AAHYS8KXpiWqzqtIT8RHjyt1UdljPf7n56w";
      	$chatid = "";
         ...
         echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN GOPAY = 205205 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"205205"}';
         ...
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("purple","!] Coba Nomer BARU Lainnya \n");
         goto ulang;
         }
//  }
